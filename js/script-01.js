...
const characterDetails = [
  {
    ...
    race: 'Arwah Manusia : entitas yang hidup di antara dua dunia, Alam Fana dan Alam Roh, terkadang hanya berbuat usil, terkadang juga meminta pertolongan.',
    trait: 'Penyayang, bijak, dan misterius.',
    background:
  ...
  },
  {
    ...
    race: 'Manusia : Sosok makhluk hidup yang rapuh di Alam Fana, penuh dengan emosi, dan esensi untuk penasaran.',
    trait: 'Cerdas, penuh empati, tapi rapuh.',
    background:
  ...
  },
  {
    ...
    race: 'Makhluk Gaib : makhluk yang terlahir murni dari energi gelap yang memiliki peranan penting mengelola dan menjaga para Roh',
    trait: 'Tegas, penuh wibawa, dan Amarah',
    background:
...

  {
    ...
    race: 'Makhluk Gaib : makhluk yang terlahir murni dari energi gelap yang memiliki peranan penting mengelola dan menjaga para Roh',
    trait: 'Tenang, licik, dan menyesatkan.',
    background:
  ...
  },
  {
    ...
    race: 'Tasbih Mode : adalah salah kekuatan Arya yang dimana setiap butir bisa menyimpan bentuk Roh atau makhluk gaib yang nantinya bisa digunakan Arya sebagai bala bantuan atau kekuatannya.',
    trait: 'Kuat, emosional, dan kehancuran.',
    background:
  ...
  },
  {
    ...
    race: 'Manusia : Sosok makhluk hidup yang rapuh di Alam Fana, penuh dengan emosi, dan esensi untuk penasaran.',
    trait: 'Riang, Rapuh, Setia, Eempati, dan Penakut.',
    background:
  ...
  },
  {
    ...
    race: 'Manusia : Sosok makhluk hidup yang rapuh di Alam Fana, penuh dengan emosi, dan esensi untuk penasaran.',
    trait: 'Keras, impulsif, dan protektif.',
    background:
  ...
  },
  {
    ...
    race: 'Manusia : Sosok makhluk hidup yang rapuh di Alam Fana, penuh dengan emosi, dan esensi untuk penasaran.',
    trait: 'Bijak, sabar, dan penuh teka-teki.',
    background:
  ...
  },
  {
    ...
    race: 'Arwah Manusia : entitas yang hidup di antara dua dunia, Alam Fana dan Alam Roh, terkadang hanya berbuat usil, terkadang juga meminta pertolongan.',
    trait: 'Sedih, penuh dendam, namun menyimpan kelembutan kasih ibu.',
    background:
  ...
  },
  {
    ...
    race: 'Arwah Manusia : entitas yang hidup di antara dua dunia, Alam Fana dan Alam Roh, terkadang hanya berbuat usil, terkadang juga meminta pertolongan.',
    trait: 'Diam, menakutkan, tidak jahat. butuh teman.',
    background:
  ...
  },
  {
    ...
    race: 'Makhluk Gaib : makhluk yang terlahir murni dari energi gelap yang memiliki peranan penting mengelola dan menjaga para Roh',
    trait: 'Usil, licik, lincah, polos, dan tamak.',
    background:
...

  {
    ...
    race: 'Makhluk Gaib : makhluk yang terlahir murni dari energi gelap yang memiliki peranan penting mengelola dan menjaga para Roh',
    trait: 'Panas, destruktif, jahil, dan amarah.',
    background:
...
function updateCharacterDetails(characterId) {
  ...
  // update teks
  document.querySelector('.dtchara-left h3').textContent = c.name;
